...
from app.schemas.balance import BalanceResponse, TransactionListResponse, BalanceStats
...
class BalanceService:
    ...
    def __init__(
        self, balance_repo: BalanceRepository, transaction_repo: TransactionRepository
    ):
    ...
    async def get_transactions(
        ...
        total = await self.transaction_repo.count_user_transactions(
            user_id=user_id, transaction_type=transaction_type, status=status
        )
