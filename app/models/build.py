...
class Build(BaseModel):
    ...
    __table_args__ = (Index("ix_builds_author_created", "author_id", "created_at"),)
...
class BuildComment(BaseModel):
    ...
    parent_id = Column(
        Integer, ForeignKey("build_comments.id", ondelete="CASCADE"), nullable=True
    ...
    parent = relationship(
        "BuildComment", remote_side="BuildComment.id", back_populates="replies"
    )
