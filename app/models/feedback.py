...
class Feedback(BaseModel):
    ...
    assigned_to = relationship(
        "User", foreign_keys=[assigned_to_id], back_populates="assigned_feedbacks"
    )

    # Индексы
    __table_args__ = (Index("ix_feedbacks_user_id", "user_id", unique=True),)
