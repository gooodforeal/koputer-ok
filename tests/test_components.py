...
class TestGetComponents:
    ...
    @pytest.mark.asyncio
    async def test_get_components_with_data(self, client, test_components):
    ...
    @pytest.mark.asyncio
    async def test_get_components_with_pagination(self, client, test_components):
...
class TestGetComponentStats:
    ...
    @pytest.mark.asyncio
    async def test_get_component_stats_with_data(self, client, test_components):
...
class TestGetComponentsByCategory:
    ...
    @pytest.mark.asyncio
    async def test_get_components_by_category_empty(self, client, db_session):
    ...
    @pytest.mark.asyncio
    async def test_get_components_by_category_with_data(self, client, test_components):
    ...
    @pytest.mark.asyncio
    async def test_get_components_by_category_with_search(self, client, db_session):
        ...
        response = client.get(
            "/api/components/by-category?category=PROCESSORY&query=Intel"
        )
    ...
    @pytest.mark.asyncio
    async def test_get_components_by_category_with_pagination(self, client, db_session):
        ...
        response = client.get(
            "/api/components/by-category?category=PROCESSORY&skip=0&limit=2"
        )
    ...
    @pytest.mark.asyncio
    async def test_get_components_by_category_unauthenticated(
        self, unauthenticated_client
    ):
        """Тест получения компонентов по категории неавторизованным пользователем"""
        response = unauthenticated_client.get(
            "/api/components/by-category?category=PROCESSORY"
        )
...
class TestParseComponents:
    ...
    async def test_start_parsing_success(self, admin_client):
        ...
        admin_client.app.dependency_overrides[get_component_parser_service] = (
            lambda: mock_service
        )
        ...
        try:
            ...
            admin_client.app.dependency_overrides.pop(
                get_component_parser_service, None
            )
