...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_transactions_balance_id"), "transactions", ["balance_id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_transactions_type"), "transactions", ["transaction_type"], unique=False
    )
    op.create_index(
        op.f("ix_transactions_payment_id"), "transactions", ["payment_id"], unique=True
    )
    op.create_index(
        op.f("ix_transactions_user_created"),
        "transactions",
        ["user_id", "created_at"],
        unique=False,
    )
